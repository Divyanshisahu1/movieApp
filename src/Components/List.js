...
export default class List extends Component {
  ...
  changeMovies = async () => {
    ...
    let ans = await axios.get(
      `https://api.themoviedb.org/3/movie/popular?api_key=66610483b54e33307bd6d620dbe28a0f&language=en-US&page=${this.state.currPage}`
    );
  ...
  async componentDidMount() {
    ...
    let ans = await axios.get(
     ...
     console.log("movieData",ans.data);
    this.setState({
      movies: [...ans.data.results], //[{},{},{}]
    });
  }
